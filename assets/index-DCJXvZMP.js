 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Qp;function r0(){return Qp||(Qp=1,function(r){function e(F,G){var j=F.length;F.push(G);e:for(;0<j;){var I=j-1>>>1,P=F[I];if(0<l(P,G))F[I]=G,F[j]=P,j=I;else break e}}function n(F){return F.length===0?null:F[0]}function s(F){if(F.length===0)return null;var G=F[0],j=F.pop();if(j!==G){F[0]=j;e:for(var I=0,P=F.length,ee=P>>>1;I<ee;){var se=2*(I+1)-1,ce=F[se],de=se+1,ve=F[de];if(0>l(ce,j))de<P&&0>l(ve,ce)?(F[I]=ve,F[de]=j,I=de):(F[I]=ce,F[se]=j,I=se);else if(de<P&&0>l(ve,j))F[I]=ve,F[de]=j,I=de;else break e}}return G}function l(F,G){var j=F.sortIndex-G.sortIndex;return j!==0?j:F.id-G.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;r.unstable_now=function(){return u.now()}}else{var d=Date,f=d.now();r.unstable_now=function(){return d.now()-f}}var p=[],g=[],w=1,y=null,S=3,R=!1,x=!1,M=!1,b=typeof setTimeout=="function"?setTimeout:null,ae=typeof clearTimeout=="function"?clearTimeout:null,Re=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function X(F){for(var G=n(g);G!==null;){if(G.callback===null)s(g);else if(G.startTime<=F)s(g),G.sortIndex=G.expirationTime,e(p,G);else break;G=n(g)}}function J(F){if(M=!1,X(F),!x)if(n(p)!==null)x=!0,ut(be);else{var G=n(g);G!==null&&xe(J,G.startTime-F)}}function be(F,G){x=!1,M&&(M=!1,ae(le),le=-1),R=!0;var j=S;try{for(X(G),y=n(p);y!==null&&(!(y.expirationTime>G)||F&&!Yt());){var I=y.callback;if(typeof I=="function"){y.callback=null,S=y.priorityLevel;var P=I(y.expirationTime<=G);G=r.unstable_now(),typeof P=="function"?y.callback=P:y===n(p)&&s(p),X(G)}else s(p);y=n(p)}if(y!==null)var ee=!0;else{var se=n(g);se!==null&&xe(J,se.startTime-G),ee=!1}return ee}finally{y=null,S=j,R=!1}}var ie=!1,Z=null,le=-1,Be=5,it=-1;function Yt(){return!(r.unstable_now()-it<Be)}function Nt(){if(Z!==null){var F=r.unstable_now();it=F;var G=!0;try{G=Z(!0,F)}finally{G?wt():(ie=!1,Z=null)}}else ie=!1}var wt;if(typeof Re=="function")wt=function(){Re(Nt)};else if(typeof MessageChannel<"u"){var Ft=new MessageChannel,Xt=Ft.port2;Ft.port1.onmessage=Nt,wt=function(){Xt.postMessage(null)}}else wt=function(){b(Nt,0)};function ut(F){Z=F,ie||(ie=!0,wt())}function xe(F,G){le=b(function(){F(r.unstable_now())},G)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(F){F.callback=null},r.unstable_continueExecution=function(){x||R||(x=!0,ut(be))},r.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Be=0<F?Math.floor(1e3/F):5},r.unstable_getCurrentPriorityLevel=function(){return S},r.unstable_getFirstCallbackNode=function(){return n(p)},r.unstable_next=function(F){switch(S){case 1:case 2:case 3:var G=3;break;default:G=S}var j=S;S=G;try{return F()}finally{S=j}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function(F,G){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var j=S;S=F;try{return G()}finally{S=j}},r.unstable_scheduleCallback=function(F,G,j){var I=r.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?I+j:I):j=I,F){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=j+P,F={id:w++,callback:G,priorityLevel:F,startTime:j,expirationTime:P,sortIndex:-1},j>I?(F.sortIndex=j,e(g,F),n(p)===null&&F===n(g)&&(M?(ae(le),le=-1):M=!0,xe(J,j-I))):(F.sortIndex=P,e(p,F),x||R||(x=!0,ut(be))),F},r.unstable_shouldYield=Yt,r.unstable_wrapCallback=function(F){var G=S;return function(){var j=S;S=G;try{return F.apply(this,arguments)}finally{S=j}}}}(nc)),nc}var Yp;function i0(){return Yp||(Yp=1,tc.exports=r0()),tc.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zl{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,n){const s=new re(yi,e),l=new re(yi,n);return this.compare(s,l)!==0}minPost(){return re.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let g_,__;function uI(r){g_=r}function cI(r){__=r}class dI extends zl{compare(e,n){const s=e.node.getPriority(),l=n.node.getPriority(),u=s.compareTo(l);return u===0?Lr(e.name,n.name):u}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return re.MIN}maxPost(){return new re(Tr,new qe("[PRIORITY-POST]",__))}makePost(e,n){const s=g_(e);return new re(n,new qe("[PRIORITY-POST]",s))}toString(){return".priority"}}const Me=new dI;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gI extends zl{constructor(e){super(),this.indexPath_=e,L(!oe(e)&&ne(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,n){const s=this.extractChild(e.node),l=this.extractChild(n.node),u=s.compareTo(l);return u===0?Lr(e.name,n.name):u}makePost(e,n){const s=Ke(e),l=K.EMPTY_NODE.updateChild(this.indexPath_,s);return new re(n,l)}maxPost(){const e=K.EMPTY_NODE.updateChild(this.indexPath_,js);return new re(Tr,e)}toString(){return Os(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _I extends zl{compare(e,n){const s=e.node.compareTo(n.node);return s===0?Lr(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return re.MIN}maxPost(){return re.MAX}makePost(e,n){const s=Ke(e);return new re(n,s)}toString(){return".value"}}const yI=new _I;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kr{constructor(e,n,s){this.source=e,this.path=n,this.snap=s,this.type=qt.OVERWRITE}operationForChild(e){return oe(this.path)?new kr(this.source,pe(),this.snap.getImmediateChild(e)):new kr(this.source,Se(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jl(r,e){return{eventCache:r,serverCache:e}}function Ss(r,e,n,s){return jl(new Rr(e,n,s),r.serverCache)}function w_(r,e,n,s){return jl(r.eventCache,new Rr(e,n,s))}function Dc(r){return r.eventCache.isFullyInitialized()?r.eventCache.getNode():null}function Nr(r){return r.serverCache.isFullyInitialized()?r.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class VC{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function ql(r,e){let n=null;for(let s=0;s<e.length;s++){const l=e[s],u=l.getPath();n!==null&&!ld(u,n.path)&&(r.eventLists_.push(n),n=null),n===null&&(n={events:[],path:u}),n.events.push(l)}n&&r.eventLists_.push(n)}function $_(r,e,n){ql(r,n),H_(r,s=>ld(s,e))}function Qt(r,e,n){ql(r,n),H_(r,s=>Mt(s,e)||Mt(e,s))}function H_(r,e){r.recursionDepth_++;let n=!0;for(let s=0;s<r.eventLists_.length;s++){const l=r.eventLists_[s];if(l){const u=l.path;e(u)?($C(r.eventLists_[s]),r.eventLists_[s]=null):n=!1}}n&&(r.eventLists_=[]),r.recursionDepth_--}function $C(r){for(let e=0;e<r.events.length;e++){const n=r.events[e];if(n!==null){r.events[e]=null;const s=n.getEventRunner();ws&&Je("event: "+n.toString()),ki(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ay=new Map;function uy(r,e){const n=Xl(r);cy(n,e),jT(n,e)}function cy(r,e){const n=ay.get(r);if(n)for(const s of n)s(e)}function jT(r,e){const n=WT();n&&n.postMessage({key:r,fid:e}),BT()}let Cr=null;function WT(){return!Cr&&"BroadcastChannel"in self&&(Cr=new BroadcastChannel("[Firebase] FID Change"),Cr.onmessage=r=>{cy(r.data.key,r.data.fid)}),Cr}function BT(){ay.size===0&&Cr&&(Cr.close(),Cr=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Al=new Ul("@firebase/auth");function Gk(r,...e){Al.logLevel<=_e.WARN&&Al.warn(`Auth (${Ti}): ${r}`,...e)}function ll(r,...e){Al.logLevel<=_e.ERROR&&Al.error(`Auth (${Ti}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zR=5*60,jR=Pg("authIdTokenMaxAge")||zR;let vg=null;const WR=r=>async e=>{const n=e&&await e.getIdTokenResult(),s=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(s&&s>jR)return;const l=n==null?void 0:n.token;vg!==l&&(vg=l,await fetch(r,{method:l?"POST":"DELETE",headers:l?{Authorization:`Bearer ${l}`}:{}}))};function BR(r=ed()){const e=Dr(r,"auth");if(e.isInitialized())return e.getImmediate();const n=v1(r,{popupRedirectResolver:MR,persistence:[q1,L1,Hy]}),s=Pg("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const u=new URL(s,location.origin);if(location.origin===u.origin){const d=WR(u.toString());O1(n,d,()=>d(n.currentUser)),A1(n,f=>d(f))}}const l=Rg("auth");return l&&E1(n,`http://${l}`),n}function VR(){var r,e;return(e=(r=document.getElementsByTagName("head"))===null||r===void 0?void 0:r[0])!==null&&e!==void 0?e:document}m1({loadJS(r){return new Promise((e,n)=>{const s=document.createElement("script");s.setAttribute("src",r),s.onload=e,s.onerror=l=>{const u=rn("internal-error");u.customData=l,n(u)},s.type="text/javascript",s.charset="UTF-8",VR().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});UR("Browser");const $R={apiKey:"AIzaSyB2SlnQ03tQfpjLMcleDimnz-wI6_BSXYE",authDomain:"my-multiplayer-dbf6b.firebaseapp.com",databaseURL:"https://my-multiplayer-dbf6b-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"my-multiplayer-dbf6b",storageBucket:"my-multiplayer-dbf6b.firebasestorage.app",messagingSenderId:"3902656578",appId:"1:3902656578:web:ea447bf59037a7d25b5ddb",measurementId:"G-3DVR8Y6VSM"},Qd=zg($R);Bk(Qd);const ra=ST(Qd),Kc=BR(Qd);k1(Kc).then(()=>{console.log("Signed in anonymously")}).catch(r=>{console.error("Error signing in anonymously:",r)});const HR=(r,e)=>{const n=Yl(ra,`players/${r}`);Y_(n,e).then(()=>{console.log("Data written successfully!")}).catch(s=>{console.error("Error writing data:",s)})},gt=(r,e)=>{const n=Yl(ra,`players/${r}`);hT(n,e).then(()=>{console.log("Data updated successfully!")}).catch(s=>{console.error("Error updating data:",s)})},qR=r=>{const e=Yl(ra,`players/${r}`);dT(e).then(()=>{console.log("Data removed successfully!")}).catch(n=>{console.error("Error deleting data:",n)})},GR="_mycharacter_1pzqp_1",KR="_moveD_1pzqp_10",QR="_moveU_1pzqp_13",YR="_moveR_1pzqp_16",XR="_moveL_1pzqp_19",JR="_dragon_1pzqp_22",ZR="_walkLeft_1pzqp_25",eN="_walkRight_1pzqp_28",tN="_name_1pzqp_31",nN="_msgContainer_1pzqp_38",rN="_msg_1pzqp_38",iN="_msgArrow_1pzqp_61",sN="_typing_1pzqp_72",oN="_blink_1pzqp_1",vr={mycharacter:GR,moveD:KR,moveU:QR,moveR:YR,moveL:XR,dragon:JR,walkLeft:ZR,walkRight:eN,name:tN,msgContainer:nN,msg:rN,msgArrow:iN,"typing-container":"_typing-container_1pzqp_72",typing:sN,blink:oN};function ia(r){var s,l;const{p:e,site:n=""}=r;return(e==null?void 0:e.page)!==n?null:q.jsxs("div",{style:{position:"relative"},children:[q.jsx("div",{className:`${vr.mycharacter} ${vr[c0[e==null?void 0:e.dir]]}`,style:{transform:`translate(${(e==null?void 0:e.x)*4}rem, ${(e==null?void 0:e.y)*4}rem)`,backgroundPosition:`${(e==null?void 0:e.vector)*-24}px 0`}}),q.jsxs("div",{className:vr.name,style:{transform:`translate(${(e==null?void 0:e.x)*4}rem, ${(e==null?void 0:e.y)*4}rem)`},children:[e.name," ",n==="forest"&&e.score]}),(((l=(s=e==null?void 0:e.msg)==null?void 0:s.trim())==null?void 0:l.length)!==0||(e==null?void 0:e.isTyping)==!0)&&q.jsx(q.Fragment,{children:q.jsxs("div",{style:{transform:`translate(${(e==null?void 0:e.x)*4}rem, ${(e==null?void 0:e.y)*4}rem)`},className:vr.msgContainer,children:[e.isTyping&&q.jsx("span",{className:vr.typing,children:"....."}),q.jsx("div",{className:vr.msg,children:e.msg}),q.jsx("div",{className:vr.msgArrow})]})})]})}ia.propTypes={p:ke.object,site:ke.string};function Jy(r){const{rows:e,cols:n,players:s=[],myPlayer:l,setPage:u}=r,d=fe.useRef(null),[f,p]=fe.useState(0),[g,w]=fe.useState(()=>N0(e,n)),[y,S]=fe.useState(()=>0),[R,x]=fe.useState(()=>0),[M,b]=fe.useState(()=>2),[ae,Re]=fe.useState(()=>0),X=(ie,Z,le)=>{const Be=le===0||le===2,it=Be?e:n;if(Z<0||Z>=it)return ie;const Yt=Be?g[Z][R].type:g[y][Z].type;return Yt===Te.ROCK?ie:(Yt===Te.WATER?b(4):b(le),Re(Nt=>(Nt+1)%4),Z)},J=()=>{g[y][R].type===Te.GAME&&(gt(l==null?void 0:l.id,{page:"home"}),u("home"))},be=ie=>{switch(console.log("##keydown",ie.key),ie.key){case"ArrowUp":S(Z=>{let le=Z-1;return console.log("##up",Z,le),X(Z,le,0)});break;case"ArrowRight":x(Z=>{let le=Z+1;return console.log("##right",Z,le),X(Z,le,1)});break;case"ArrowDown":S(Z=>{let le=Z+1;return console.log("##down",Z,le),X(Z,le,2)});break;case"ArrowLeft":x(Z=>{let le=Z-1;return console.log("##left",Z,le),X(Z,le,3)});break;case" ":break;case"Enter":J();break}};return fe.useEffect(()=>{g[y][R].type===Te.FOOD&&setTimeout(()=>{let Z=g;Z[y][R].type=Te.EMPTY,w(Z),p(le=>le+1)},400);let ie={x:R,y,dir:M,vector:ae,score:f};gt(l==null?void 0:l.id,ie)},[y,R]),fe.useEffect(()=>{var ie;d&&((ie=d==null?void 0:d.current)==null||ie.focus(),S((l==null?void 0:l.y)||0),x((l==null?void 0:l.x)||0),p((l==null?void 0:l.score)||0))},[]),q.jsxs("div",{tabIndex:"0",onKeyDown:be,ref:d,className:ci.boardContainer,children:[q.jsxs("div",{children:[" Score: ",f]}),q.jsxs("div",{className:ci.board,children:[s==null?void 0:s.map(ie=>q.jsx(ia,{p:ie,site:"forest"},ie.id)),g.map((ie,Z)=>q.jsx("div",{className:ci.row,children:ie.map((le,Be)=>{const it=y===Z&&R===Be;return q.jsx(Ml,{isActive:it,type:le==null?void 0:le.type,site:"forest"},Be)})},Z))]})]})}Jy.propTypes={rows:ke.number.isRequired,cols:ke.number.isRequired,players:ke.array,myPlayer:ke.object,setPage:ke.func};const lN="_newPlayer_1dkh4_1",aN="_btnSubmit_1dkh4_10",wg={newPlayer:lN,btnSubmit:aN};function Zy(r){const{user:e,setNewPlayer:n}=r,[s,l]=fe.useState(""),[u,d]=fe.useState("male"),f=()=>{if(s.trim().length===0)return;n(!1);const g={name:s,score:0,x:0,y:0,character:"",dir:2,vector:0,page:"home",msg:""};HR(e==null?void 0:e.id,g)},p=g=>{d(g.target.value)};return q.jsxs("div",{className:wg.newPlayer,children:[q.jsx("div",{children:"New player"}),q.jsx("input",{type:"text",placeholder:"Enter your name",value:s,onChange:g=>l(g.target.value)}),q.jsx("br",{}),q.jsxs("select",{value:u,onChange:p,children:[q.jsx("option",{value:"male",children:"Man"}),q.jsx("option",{value:"female",children:"Women"}),q.jsx("option",{value:"snake",children:"Snake"})]}),q.jsx("button",{className:wg.btnSubmit,onClick:f,children:"Submit"})]})}Zy.propTypes={user:ke.object.isRequired,setNewPlayer:ke.func.isRequired};const wr=[["null","wood","wood","null","null","null","null","null","null","wood","wood","null"],["null","wood","wood","empty","null","null","null","null","sellApple","wood","wood","null"],["empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty"],["empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty"],["game","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty"],["empty","empty","empty","empty","water","water","water","water","empty","empty","empty","empty"],["empty","empty","empty","empty","water","water","water","water","empty","empty","empty","empty"],["empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty"],["grass","grass","grass","grass","grass","grass","grass","grass","grass","grass","grass","grass"]],uN="_home_b7lxk_1",cN="_hint_b7lxk_10",Eg={home:uN,hint:cN},dN="_editor_ge73_1",hN="_input_ge73_9",Sg={editor:dN,input:hN};function ev(r){const{id:e,boardRef:n,isTyping:s,msg:l,setIsTyping:u,setMsg:d}=r,f=fe.useRef(null),[p,g]=fe.useState(2),w=y=>{var S,R;console.log("##handleKeyPress",y.key),y.key==="Enter"&&!y.shiftKey&&(l==null?void 0:l.trim().length)>0?(y.preventDefault(),gt(e,{isTyping:!1,msg:l}),u(!1),d(""),g(2),(S=n==null?void 0:n.current)==null||S.focus()):y.key==="Enter"&&y.shiftKey&&p<16?g(x=>x+1):y.key==="Backspace"&&p>2?g(x=>x-1):y.key==="Escape"&&(u(!1),d(""),gt(e,{isTyping:!1}),(R=n==null?void 0:n.current)==null||R.focus())};if(s)return q.jsx("div",{className:Sg.editor,children:q.jsx("textarea",{ref:f,value:l,autoFocus:!0,className:Sg.input,placeholder:"Type your message...",onChange:y=>{var S;console.log("##onChange",y.target.value,(S=y.target.value)==null?void 0:S.length),d(y.target.value)},onKeyUp:w,rows:p.toString()})})}ev.propTypes={id:ke.string,boardRef:ke.object,isTyping:ke.bool,setIsTyping:ke.func,setMsg:ke.func,msg:ke.string};function tv(r){const{players:e=[],myPlayer:n,setPage:s}=r,{x:l,y:u,id:d,vector:f}=n,p=fe.useRef(null),[g,w]=fe.useState("Press Enter to type message, and again Enter to send it. Esc to cancel or delete."),[y,S]=fe.useState(!1),[R,x]=fe.useState(""),M=(X,J)=>e.some(be=>be.x===X&&be.y===J),b=(X,J)=>X<0||X>=wr[0].length||J<0||J>=wr.length?2:wr[J][X]===Te.WATER||M(X,J)?0:1,ae=()=>{var X;b(l,u)!==2&&(wr[u][l]===Te.GAME?(gt(d,{page:"forest"}),s("forest")):wr[u][l]===Te.FREE_WAY?(gt(d,{page:"freeway"}),s("freeway")):wr[u][l]===Te.SELL_APPLE?gt(d,{score:0}):(b(l,u)===1||b(l,u)===0)&&((X=p==null?void 0:p.current)==null||X.blur(),S(!0),gt(d,{isTyping:!0})))},Re=X=>{X.preventDefault();let J={};switch(X.key){case"ArrowUp":J={dir:0,vector:(f+1)%4},b(l,u-1)&&(J.y=u-1),gt(d,J);break;case"ArrowRight":J={dir:1,vector:(f+1)%4},b(l+1,u)&&(J.x=l+1),gt(d,J);break;case"ArrowDown":J={dir:2,vector:(f+1)%4},b(l,u+1)&&(J.y=u+1),gt(d,J);break;case"ArrowLeft":J={dir:3,vector:(f+1)%4},b(l-1,u)&&(J.x=l-1),gt(d,J);break;case" ":break;case"Enter":ae();break;case"Escape":x(""),gt(d,{isTyping:!1,msg:""});break}};return fe.useEffect(()=>{w(l===0&&u===4?"Press enter":"Press Enter to type message, and again Enter to send it. Esc to cancel or delete.")},[l,u]),fe.useEffect(()=>{var X;p&&((X=p==null?void 0:p.current)==null||X.focus())},[]),q.jsxs(q.Fragment,{children:[q.jsxs("div",{className:Eg.home,tabIndex:"0",onKeyDown:Re,ref:p,children:["Living area",q.jsxs("div",{className:Eg.hint,children:["Hint: ",g]}),q.jsxs("div",{children:[e==null?void 0:e.map(X=>q.jsx(ia,{p:X,site:"home"},X.id)),wr.map((X,J)=>q.jsx("div",{className:ci.row,children:X.map((be,ie)=>q.jsx(Ml,{type:be,site:"home"},ie))},J))]})]}),q.jsx(ev,{id:d,isTyping:y,msg:R,boardRef:p,setIsTyping:S,setMsg:x})]})}tv.propTypes={players:ke.array,myPlayer:ke.object,setPage:ke.func};function nv(r){const{rows:e,cols:n,myPlayer:s,players:l}=r,[u]=fe.useState(()=>{let x=[];for(let M=0;M<e;M++){let b=[];for(let ae=0;ae<n;ae++)b.push({isActive:!1,type:Te.EMPTY});x.push(b)}return x}),[d,f]=fe.useState({row:0,col:0}),[p,g]=fe.useState(0),[w,y]=fe.useState(new Set),S=x=>{y(M=>new Set(M).add(x.key))},R=x=>{y(M=>{const b=new Set(M);return b.delete(x.key),b})};return fe.useEffect(()=>{const x=()=>{console.log("#####ctiveKeys",w),f(M=>{let{row:b,col:ae}=M;return w.has("ArrowLeft")&&(ae=Math.max(0,ae-1),g(270)),w.has("ArrowRight")&&(ae=Math.min(n-1,ae+1),g(90)),w.has("ArrowUp")&&(b=Math.max(0,b-1),g(0)),w.has("ArrowDown")&&(b=Math.min(e-1,b+1),g(180)),{row:b,col:ae}})};if(w.size>0){const M=setInterval(x,100);return()=>clearInterval(M)}},[w]),console.log("position",l),q.jsx("div",{tabIndex:"0",onKeyDown:S,onKeyUp:R,children:q.jsxs("div",{className:ci.board,children:[l==null?void 0:l.map(x=>q.jsx(ia,{p:x,site:"freeway"},x.id)),u.map((x,M)=>q.jsx("div",{className:ci.row,children:x.map((b,ae)=>{const Re=d.row===M&&d.col===ae;return q.jsx(Ml,{isActive:Re,tile:b,site:"freeway"},ae)})},M))]})})}nv.propTypes={rows:ke.number.isRequired,cols:ke.number.isRequired,players:ke.array,myPlayer:ke.object};function fN(){const[r,e]=fe.useState(!0),[n,s]=fe.useState({}),[l,u]=fe.useState([]),[d,f]=fe.useState("home"),p=y=>{if(!y)return;let S=[];for(const R in y)R===n.id&&(s({id:R,...y[R]}),e(!1)),S.push({id:R,...y[R]});u(S)},g=()=>{qR(n==null?void 0:n.id),e(!0),s({})},w=()=>{d!=="home"&&(f("home"),gt(n==null?void 0:n.id,{page:"home"}))};return fe.useEffect(()=>Kc.onAuthStateChanged(S=>{if(S){let R=n;R.id=S.uid,s(R)}else console.log("User signed out")}),[Kc]),fe.useEffect(()=>{const y=Yl(ra,"players"),S=pT(y,R=>{p(R.val())});return()=>S()},[]),r?q.jsx(Zy,{user:n,setNewPlayer:e}):q.jsxs(q.Fragment,{children:[q.jsxs("div",{style:{padding:"1rem",fontWeight:"bolder",display:"flex",justifyContent:"space-between"},children:[q.jsx("button",{onClick:w,children:"Home"}),q.jsx("button",{onClick:g,children:"Reset"})]}),d==="home"&&q.jsx(tv,{myPlayer:n,players:l,setPage:f}),d==="forest"&&q.jsx(Jy,{rows:9,cols:12,myPlayer:n,players:l,setPage:f}),d==="freeWay"&&q.jsx(nv,{rows:10,cols:10,myPlayer:n,players:l})]})}a0.createRoot(document.getElementById("root")).render(q.jsx(fe.StrictMode,{children:q.jsx(fN,{})}));
