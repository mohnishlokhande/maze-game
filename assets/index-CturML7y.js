 ...
 */var Hp;function e0(){if(Hp)return te;Hp=1;var r=Symbol.for("react.element"),e=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.provider"),d=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),y=Symbol.iterator;function S(I){return I===null||typeof I!="object"?null:(I=y&&I[y]||I["@@iterator"],typeof I=="function"?I:null)}var R={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},x=Object.assign,M={};function U(I,P,ee){this.props=I,this.context=P,this.refs=M,this.updater=ee||R}U.prototype.isReactComponent={},U.prototype.setState=function(I,P){if(typeof I!="object"&&typeof I!="function"&&I!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,I,P,"setState")},U.prototype.forceUpdate=function(I){this.updater.enqueueForceUpdate(this,I,"forceUpdate")};function le(){}le.prototype=U.prototype;function J(I,P,ee){this.props=I,this.context=P,this.refs=M,this.updater=ee||R}var Z=J.prototype=new le;Z.constructor=J,x(Z,U.prototype),Z.isPureReactComponent=!0;var Ie=Array.isArray,We=Object.prototype.hasOwnProperty,ae={current:null},X={key:!0,ref:!0,__self:!0,__source:!0};function oe(I,P,ee){var ie,ce={},de=null,ve=null;if(P!=null)for(ie in P.ref!==void 0&&(ve=P.ref),P.key!==void 0&&(de=""+P.key),P)We.call(P,ie)&&!X.hasOwnProperty(ie)&&(ce[ie]=P[ie]);var me=arguments.length-2;if(me===1)ce.children=ee;else if(1<me){for(var Re=Array(me),Et=0;Et<me;Et++)Re[Et]=arguments[Et+2];ce.children=Re}if(I&&I.defaultProps)for(ie in me=I.defaultProps,me)ce[ie]===void 0&&(ce[ie]=me[ie]);return{$$typeof:r,type:I,key:de,ref:ve,props:ce,_owner:ae.current}}function Be(I,P){return{$$typeof:r,type:I.type,key:P,ref:I.ref,props:I.props,_owner:I._owner}}function it(I){return typeof I=="object"&&I!==null&&I.$$typeof===r}function Yt(I){var P={"=":"=0",":":"=2"};return"$"+I.replace(/[=:]/g,function(ee){return P[ee]})}var Nt=/\/+/g;function wt(I,P){return typeof I=="object"&&I!==null&&I.key!=null?Yt(""+I.key):P.toString(36)}function Ft(I,P,ee,ie,ce){var de=typeof I;(de==="undefined"||de==="boolean")&&(I=null);var ve=!1;if(I===null)ve=!0;else switch(de){case"string":case"number":ve=!0;break;case"object":switch(I.$$typeof){case r:case e:ve=!0}}if(ve)return ve=I,ce=ce(ve),I=ie===""?"."+wt(ve,0):ie,Ie(ce)?(ee="",I!=null&&(ee=I.replace(Nt,"$&/")+"/"),Ft(ce,P,ee,"",function(Et){return Et})):ce!=null&&(it(ce)&&(ce=Be(ce,ee+(!ce.key||ve&&ve.key===ce.key?"":(""+ce.key).replace(Nt,"$&/")+"/")+I)),P.push(ce)),1;if(ve=0,ie=ie===""?".":ie+":",Ie(I))for(var me=0;me<I.length;me++){de=I[me];var Re=ie+wt(de,me);ve+=Ft(de,P,ee,Re,ce)}else if(Re=S(I),typeof Re=="function")for(I=Re.call(I),me=0;!(de=I.next()).done;)de=de.value,Re=ie+wt(de,me++),ve+=Ft(de,P,ee,Re,ce);else if(de==="object")throw P=String(I),Error("Objects are not valid as a React child (found: "+(P==="[object Object]"?"object with keys {"+Object.keys(I).join(", ")+"}":P)+"). If you meant to render a collection of children, use an array instead.");return ve}function Xt(I,P,ee){if(I==null)return I;var ie=[],ce=0;return Ft(I,ie,"","",function(de){return P.call(ee,de,ce++)}),ie}function ut(I){if(I._status===-1){var P=I._result;P=P(),P.then(function(ee){(I._status===0||I._status===-1)&&(I._status=1,I._result=ee)},function(ee){(I._status===0||I._status===-1)&&(I._status=2,I._result=ee)}),I._status===-1&&(I._status=0,I._result=P)}if(I._status===1)return I._result.default;throw I._result}var xe={current:null},b={transition:null},q={ReactCurrentDispatcher:xe,ReactCurrentBatchConfig:b,ReactCurrentOwner:ae};function j(){throw Error("act(...) is not supported in production builds of React.")}return te.Children={map:Xt,forEach:function(I,P,ee){Xt(I,function(){P.apply(this,arguments)},ee)},count:function(I){var P=0;return Xt(I,function(){P++}),P},toArray:function(I){return Xt(I,function(P){return P})||[]},only:function(I){if(!it(I))throw Error("React.Children.only expected to receive a single React element child.");return I}},te.Component=U,te.Fragment=n,te.Profiler=l,te.PureComponent=J,te.StrictMode=s,te.Suspense=p,te.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=q,te.act=j,te.cloneElement=function(I,P,ee){if(I==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+I+".");var ie=x({},I.props),ce=I.key,de=I.ref,ve=I._owner;if(P!=null){if(P.ref!==void 0&&(de=P.ref,ve=ae.current),P.key!==void 0&&(ce=""+P.key),I.type&&I.type.defaultProps)var me=I.type.defaultProps;for(Re in P)We.call(P,Re)&&!X.hasOwnProperty(Re)&&(ie[Re]=P[Re]===void 0&&me!==void 0?me[Re]:P[Re])}var Re=arguments.length-2;if(Re===1)ie.children=ee;else if(1<Re){me=Array(Re);for(var Et=0;Et<Re;Et++)me[Et]=arguments[Et+2];ie.children=me}return{$$typeof:r,type:I.type,key:ce,ref:de,props:ie,_owner:ve}},te.createContext=function(I){return I={$$typeof:d,_currentValue:I,_currentValue2:I,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},I.Provider={$$typeof:u,_context:I},I.Consumer=I},te.createElement=oe,te.createFactory=function(I){var P=oe.bind(null,I);return P.type=I,P},te.createRef=function(){return{current:null}},te.forwardRef=function(I){return{$$typeof:f,render:I}},te.isValidElement=it,te.lazy=function(I){return{$$typeof:w,_payload:{_status:-1,_result:I},_init:ut}},te.memo=function(I,P){return{$$typeof:g,type:I,compare:P===void 0?null:P}},te.startTransition=function(I){var P=b.transition;b.transition={};try{I()}finally{b.transition=P}},te.unstable_act=j,te.useCallback=function(I,P){return xe.current.useCallback(I,P)},te.useContext=function(I){return xe.current.useContext(I)},te.useDebugValue=function(){},te.useDeferredValue=function(I){return xe.current.useDeferredValue(I)},te.useEffect=function(I,P){return xe.current.useEffect(I,P)},te.useId=function(){return xe.current.useId()},te.useImperativeHandle=function(I,P,ee){return xe.current.useImperativeHandle(I,P,ee)},te.useInsertionEffect=function(I,P){return xe.current.useInsertionEffect(I,P)},te.useLayoutEffect=function(I,P){return xe.current.useLayoutEffect(I,P)},te.useMemo=function(I,P){return xe.current.useMemo(I,P)},te.useReducer=function(I,P,ee){return xe.current.useReducer(I,P,ee)},te.useRef=function(I){return xe.current.useRef(I)},te.useState=function(I){return xe.current.useState(I)},te.useSyncExternalStore=function(I,P,ee){return xe.current.useSyncExternalStore(I,P,ee)},te.useTransition=function(){return xe.current.useTransition()},te.version="18.3.1",te}var qp;function Qc(){return qp||(qp=1,Zu.exports=e0()),Zu.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Qp;function r0(){return Qp||(Qp=1,function(r){function e(b,q){var j=b.length;b.push(q);e:for(;0<j;){var I=j-1>>>1,P=b[I];if(0<l(P,q))b[I]=q,b[j]=P,j=I;else break e}}function n(b){return b.length===0?null:b[0]}function s(b){if(b.length===0)return null;var q=b[0],j=b.pop();if(j!==q){b[0]=j;e:for(var I=0,P=b.length,ee=P>>>1;I<ee;){var ie=2*(I+1)-1,ce=b[ie],de=ie+1,ve=b[de];if(0>l(ce,j))de<P&&0>l(ve,ce)?(b[I]=ve,b[de]=j,I=de):(b[I]=ce,b[ie]=j,I=ie);else if(de<P&&0>l(ve,j))b[I]=ve,b[de]=j,I=de;else break e}}return q}function l(b,q){var j=b.sortIndex-q.sortIndex;return j!==0?j:b.id-q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;r.unstable_now=function(){return u.now()}}else{var d=Date,f=d.now();r.unstable_now=function(){return d.now()-f}}var p=[],g=[],w=1,y=null,S=3,R=!1,x=!1,M=!1,U=typeof setTimeout=="function"?setTimeout:null,le=typeof clearTimeout=="function"?clearTimeout:null,J=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function Z(b){for(var q=n(g);q!==null;){if(q.callback===null)s(g);else if(q.startTime<=b)s(g),q.sortIndex=q.expirationTime,e(p,q);else break;q=n(g)}}function Ie(b){if(M=!1,Z(b),!x)if(n(p)!==null)x=!0,ut(We);else{var q=n(g);q!==null&&xe(Ie,q.startTime-b)}}function We(b,q){x=!1,M&&(M=!1,le(oe),oe=-1),R=!0;var j=S;try{for(Z(q),y=n(p);y!==null&&(!(y.expirationTime>q)||b&&!Yt());){var I=y.callback;if(typeof I=="function"){y.callback=null,S=y.priorityLevel;var P=I(y.expirationTime<=q);q=r.unstable_now(),typeof P=="function"?y.callback=P:y===n(p)&&s(p),Z(q)}else s(p);y=n(p)}if(y!==null)var ee=!0;else{var ie=n(g);ie!==null&&xe(Ie,ie.startTime-q),ee=!1}return ee}finally{y=null,S=j,R=!1}}var ae=!1,X=null,oe=-1,Be=5,it=-1;function Yt(){return!(r.unstable_now()-it<Be)}function Nt(){if(X!==null){var b=r.unstable_now();it=b;var q=!0;try{q=X(!0,b)}finally{q?wt():(ae=!1,X=null)}}else ae=!1}var wt;if(typeof J=="function")wt=function(){J(Nt)};else if(typeof MessageChannel<"u"){var Ft=new MessageChannel,Xt=Ft.port2;Ft.port1.onmessage=Nt,wt=function(){Xt.postMessage(null)}}else wt=function(){U(Nt,0)};function ut(b){X=b,ae||(ae=!0,wt())}function xe(b,q){oe=U(function(){b(r.unstable_now())},q)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(b){b.callback=null},r.unstable_continueExecution=function(){x||R||(x=!0,ut(We))},r.unstable_forceFrameRate=function(b){0>b||125<b?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Be=0<b?Math.floor(1e3/b):5},r.unstable_getCurrentPriorityLevel=function(){return S},r.unstable_getFirstCallbackNode=function(){return n(p)},r.unstable_next=function(b){switch(S){case 1:case 2:case 3:var q=3;break;default:q=S}var j=S;S=q;try{return b()}finally{S=j}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function(b,q){switch(b){case 1:case 2:case 3:case 4:case 5:break;default:b=3}var j=S;S=b;try{return q()}finally{S=j}},r.unstable_scheduleCallback=function(b,q,j){var I=r.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?I+j:I):j=I,b){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=j+P,b={id:w++,callback:q,priorityLevel:b,startTime:j,expirationTime:P,sortIndex:-1},j>I?(b.sortIndex=j,e(g,b),n(p)===null&&b===n(g)&&(M?(le(oe),oe=-1):M=!0,xe(Ie,j-I))):(b.sortIndex=P,e(p,b),x||R||(x=!0,ut(We))),b},r.unstable_shouldYield=Yt,r.unstable_wrapCallback=function(b){var q=S;return function(){var j=S;S=q;try{return b.apply(this,arguments)}finally{S=j}}}}(nc)),nc}var Yp;function i0(){return Yp||(Yp=1,tc.exports=r0()),tc.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wl{constructor(e,n,s){this.path=e,this.affectedTree=n,this.revert=s,this.type=qt.ACK_USER_WRITE,this.source=hd()}operationForChild(e){if(se(this.path)){if(this.affectedTree.value!=null)return L(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new ye(e));return new wl(pe(),n,this.revert)}}else return L(ne(this.path)===e,"operationForChild called for unrelated child."),new wl(Se(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ms{constructor(e,n){this.source=e,this.path=n,this.type=qt.LISTEN_COMPLETE}operationForChild(e){return se(this.path)?new Ms(this.source,pe()):new Ms(this.source,Se(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tr{constructor(e,n,s){this.source=e,this.path=n,this.snap=s,this.type=qt.OVERWRITE}operationForChild(e){return se(this.path)?new Tr(this.source,pe(),this.snap.getImmediateChild(e)):new Tr(this.source,Se(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zR=5*60,jR=Pg("authIdTokenMaxAge")||zR;let vg=null;const WR=r=>async e=>{const n=e&&await e.getIdTokenResult(),s=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(s&&s>jR)return;const l=n==null?void 0:n.token;vg!==l&&(vg=l,await fetch(r,{method:l?"POST":"DELETE",headers:l?{Authorization:`Bearer ${l}`}:{}}))};function BR(r=ed()){const e=xr(r,"auth");if(e.isInitialized())return e.getImmediate();const n=v1(r,{popupRedirectResolver:MR,persistence:[q1,L1,Hy]}),s=Pg("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const u=new URL(s,location.origin);if(location.origin===u.origin){const d=WR(u.toString());O1(n,d,()=>d(n.currentUser)),A1(n,f=>d(f))}}const l=Rg("auth");return l&&E1(n,`http://${l}`),n}function VR(){var r,e;return(e=(r=document.getElementsByTagName("head"))===null||r===void 0?void 0:r[0])!==null&&e!==void 0?e:document}m1({loadJS(r){return new Promise((e,n)=>{const s=document.createElement("script");s.setAttribute("src",r),s.onload=e,s.onerror=l=>{const u=rn("internal-error");u.customData=l,n(u)},s.type="text/javascript",s.charset="UTF-8",VR().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});UR("Browser");const $R={apiKey:"AIzaSyB2SlnQ03tQfpjLMcleDimnz-wI6_BSXYE",authDomain:"my-multiplayer-dbf6b.firebaseapp.com",databaseURL:"https://my-multiplayer-dbf6b-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"my-multiplayer-dbf6b",storageBucket:"my-multiplayer-dbf6b.firebasestorage.app",messagingSenderId:"3902656578",appId:"1:3902656578:web:ea447bf59037a7d25b5ddb",measurementId:"G-3DVR8Y6VSM"},Qd=zg($R);Bk(Qd);const ra=ST(Qd),Kc=BR(Qd);k1(Kc).then(()=>{console.log("Signed in anonymously")}).catch(r=>{console.error("Error signing in anonymously:",r)});const HR=(r,e)=>{const n=Yl(ra,`players/${r}`);Y_(n,e).then(()=>{console.log("Data written successfully!")}).catch(s=>{console.error("Error writing data:",s)})},gt=(r,e)=>{const n=Yl(ra,`players/${r}`);hT(n,e).then(()=>{console.log("Data updated successfully!")}).catch(s=>{console.error("Error updating data:",s)})},qR=r=>{const e=Yl(ra,`players/${r}`);dT(e).then(()=>{console.log("Data removed successfully!")}).catch(n=>{console.error("Error deleting data:",n)})},GR="_mycharacter_rf43a_1",KR="_moveD_rf43a_10",QR="_moveU_rf43a_13",YR="_moveR_rf43a_16",XR="_moveL_rf43a_19",JR="_dragon_rf43a_22",ZR="_walkLeft_rf43a_25",eN="_walkRight_rf43a_28",tN="_name_rf43a_31",nN="_msgContainer_rf43a_37",rN="_msg_rf43a_37",vs={mycharacter:GR,moveD:KR,moveU:QR,moveR:YR,moveL:XR,dragon:JR,walkLeft:ZR,walkRight:eN,name:tN,msgContainer:nN,msg:rN};function ia(r){var s,l;const{p:e,site:n=""}=r;return(e==null?void 0:e.page)!==n?null:G.jsxs("div",{style:{position:"relative"},children:[G.jsx("div",{className:`${vs.mycharacter} ${vs[c0[e==null?void 0:e.dir]]}`,style:{transform:`translate(${(e==null?void 0:e.x)*4}rem, ${(e==null?void 0:e.y)*4}rem)`,backgroundPosition:`${(e==null?void 0:e.vector)*-24}px 0`}}),G.jsxs("div",{className:vs.name,style:{transform:`translate(${(e==null?void 0:e.x)*4}rem, ${(e==null?void 0:e.y)*4}rem)`},children:[e.name," ",n==="forest"&&e.score]}),((l=(s=e==null?void 0:e.msg)==null?void 0:s.trim())==null?void 0:l.length)!==0&&G.jsx("div",{className:vs.msgContainer,style:{transform:`translate(${(e==null?void 0:e.x)*4}rem, ${(e==null?void 0:e.y)*4}rem)`},children:G.jsx("div",{className:vs.msg,children:e.msg})})]})}ia.propTypes={p:Pe.object,site:Pe.string};function Jy(r){const{rows:e,cols:n,players:s=[],myPlayer:l,setPage:u}=r,d=fe.useRef(null),[f,p]=fe.useState(0),[g,w]=fe.useState(()=>N0(e,n)),[y,S]=fe.useState(()=>0),[R,x]=fe.useState(()=>0),[M,U]=fe.useState(()=>2),[le,J]=fe.useState(()=>0),Z=(ae,X,oe)=>{const Be=oe===0||oe===2,it=Be?e:n;if(X<0||X>=it)return ae;const Yt=Be?g[X][R].type:g[y][X].type;return Yt===ke.ROCK?ae:(Yt===ke.WATER?U(4):U(oe),J(Nt=>(Nt+1)%4),X)},Ie=()=>{g[y][R].type===ke.GAME&&(gt(l==null?void 0:l.id,{page:"home"}),u("home"))},We=ae=>{switch(console.log("##keydown",ae.key),ae.key){case"ArrowUp":S(X=>{let oe=X-1;return console.log("##up",X,oe),Z(X,oe,0)});break;case"ArrowRight":x(X=>{let oe=X+1;return console.log("##right",X,oe),Z(X,oe,1)});break;case"ArrowDown":S(X=>{let oe=X+1;return console.log("##down",X,oe),Z(X,oe,2)});break;case"ArrowLeft":x(X=>{let oe=X-1;return console.log("##left",X,oe),Z(X,oe,3)});break;case" ":break;case"Enter":Ie();break}};return fe.useEffect(()=>{g[y][R].type===ke.FOOD&&setTimeout(()=>{let X=g;X[y][R].type=ke.EMPTY,w(X),p(oe=>oe+1)},400);let ae={x:R,y,dir:M,vector:le,score:f};gt(l==null?void 0:l.id,ae)},[y,R]),fe.useEffect(()=>{var ae;d&&((ae=d==null?void 0:d.current)==null||ae.focus(),S((l==null?void 0:l.y)||0),x((l==null?void 0:l.x)||0),p((l==null?void 0:l.score)||0))},[]),G.jsxs("div",{tabIndex:"0",onKeyDown:We,ref:d,className:ui.boardContainer,children:[G.jsxs("div",{children:[" Score: ",f]}),G.jsxs("div",{className:ui.board,children:[s==null?void 0:s.map(ae=>G.jsx(ia,{p:ae,site:"forest"},ae.id)),g.map((ae,X)=>G.jsx("div",{className:ui.row,children:ae.map((oe,Be)=>{const it=y===X&&R===Be;return G.jsx(Ml,{isActive:it,type:oe==null?void 0:oe.type},Be)})},X))]})]})}Jy.propTypes={rows:Pe.number.isRequired,cols:Pe.number.isRequired,players:Pe.array,myPlayer:Pe.object,setPage:Pe.func};const iN="_newPlayer_1dkh4_1",sN="_btnSubmit_1dkh4_10",wg={newPlayer:iN,btnSubmit:sN};function Zy(r){const{user:e,setNewPlayer:n}=r,[s,l]=fe.useState(""),[u,d]=fe.useState("male"),f=()=>{if(s.trim().length===0)return;n(!1);const g={name:s,score:0,x:0,y:0,character:"",dir:2,vector:0,page:"home",msg:""};HR(e==null?void 0:e.id,g)},p=g=>{d(g.target.value)};return G.jsxs("div",{className:wg.newPlayer,children:[G.jsx("div",{children:"New player"}),G.jsx("input",{type:"text",placeholder:"Enter your name",value:s,onChange:g=>l(g.target.value)}),G.jsx("br",{}),G.jsxs("select",{value:u,onChange:p,children:[G.jsx("option",{value:"male",children:"Man"}),G.jsx("option",{value:"female",children:"Women"}),G.jsx("option",{value:"snake",children:"Snake"})]}),G.jsx("button",{className:wg.btnSubmit,onClick:f,children:"Submit"})]})}Zy.propTypes={user:Pe.object.isRequired,setNewPlayer:Pe.func.isRequired};const vr=[["null","wood","wood","null","null","null","null","null","null","wood","wood","null"],["null","wood","wood","empty","null","null","null","null","sellApple","wood","wood","null"],["empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty"],["empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty"],["game","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty"],["empty","empty","empty","empty","water","water","water","water","empty","empty","empty","empty"],["empty","empty","empty","empty","water","water","water","water","empty","empty","empty","empty"],["empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty"],["empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty","empty"]],oN="_home_b7lxk_1",lN="_hint_b7lxk_10",Eg={home:oN,hint:lN},aN="_editor_ge73_1",uN="_input_ge73_9",Sg={editor:aN,input:uN};function ev(r){const{id:e,boardRef:n,isTyping:s,msg:l,setIsTyping:u,setMsg:d}=r,f=fe.useRef(null),[p,g]=fe.useState(2),w=y=>{var S,R;console.log("##handleKeyPress",y.key),y.key==="Enter"&&!y.shiftKey&&(l==null?void 0:l.trim().length)>0?(y.preventDefault(),gt(e,{isTyping:!1,msg:l}),u(!1),d(""),g(2),(S=n==null?void 0:n.current)==null||S.focus()):y.key==="Enter"&&y.shiftKey&&p<16?g(x=>x+1):y.key==="Backspace"&&p>2?g(x=>x-1):y.key==="Escape"&&(u(!1),d(""),gt(e,{isTyping:!1}),(R=n==null?void 0:n.current)==null||R.focus())};if(s)return G.jsx("div",{className:Sg.editor,children:G.jsx("textarea",{ref:f,value:l,autoFocus:!0,className:Sg.input,placeholder:"Type your message...",onChange:y=>{var S;console.log("##onChange",y.target.value,(S=y.target.value)==null?void 0:S.length),d(y.target.value)},onKeyUp:w,rows:p.toString()})})}ev.propTypes={id:Pe.string,boardRef:Pe.object,isTyping:Pe.bool,setIsTyping:Pe.func,setMsg:Pe.func,msg:Pe.string};function tv(r){const{players:e=[],myPlayer:n,setPage:s}=r,{x:l,y:u,id:d,vector:f}=n,p=fe.useRef(null),[g,w]=fe.useState("Press Enter to type message, and again Enter to send it. Esc to cancel or delete."),[y,S]=fe.useState(!1),[R,x]=fe.useState(""),M=(J,Z)=>J<0||J>=vr[0].length||Z<0||Z>=vr.length?2:vr[Z][J]===ke.WATER?0:1,U=()=>{var J;M(l,u)!==2&&(vr[u][l]===ke.GAME?(gt(d,{page:"forest"}),s("forest")):vr[u][l]===ke.FREE_WAY?(gt(d,{page:"freeway"}),s("freeway")):vr[u][l]===ke.SELL_APPLE?gt(d,{score:0}):M(l,u)===1&&((J=p==null?void 0:p.current)==null||J.blur(),S(!0),gt(d,{isTyping:!0})))},le=J=>{J.preventDefault();let Z={};switch(J.key){case"ArrowUp":if(!M(l,u-1))return;Z={y:u-1,dir:0,vector:(f+1)%4},gt(d,Z);break;case"ArrowRight":if(!M(l+1,u))return;Z={x:l+1,dir:1,vector:(f+1)%4},gt(d,Z);break;case"ArrowDown":if(!M(l,u+1))return;Z={y:u+1,dir:2,vector:(f+1)%4},gt(d,Z);break;case"ArrowLeft":if(Z={x:l-1,dir:3,vector:(f+1)%4},!M(l-1,u))return;gt(d,Z);break;case" ":break;case"Enter":U();break;case"Escape":x(""),gt(d,{isTyping:!1,msg:""});break}};return fe.useEffect(()=>{w(l===0&&u===4?"Press enter":"Press Enter to type message, and again Enter to send it. Esc to cancel or delete.")},[l,u]),fe.useEffect(()=>{var J;p&&((J=p==null?void 0:p.current)==null||J.focus())},[]),G.jsxs(G.Fragment,{children:[G.jsxs("div",{className:Eg.home,tabIndex:"0",onKeyDown:le,ref:p,children:["Living area",G.jsxs("div",{className:Eg.hint,children:["Hint: ",g]}),G.jsxs("div",{children:[e==null?void 0:e.map(J=>G.jsx(ia,{p:J,site:"home"},J.id)),vr.map((J,Z)=>G.jsx("div",{className:ui.row,children:J.map((Ie,We)=>G.jsx(Ml,{type:Ie},We))},Z))]})]}),G.jsx(ev,{id:d,isTyping:y,msg:R,boardRef:p,setIsTyping:S,setMsg:x})]})}tv.propTypes={players:Pe.array,myPlayer:Pe.object,setPage:Pe.func};function nv(r){const{rows:e,cols:n,myPlayer:s,players:l}=r,[u]=fe.useState(()=>{let x=[];for(let M=0;M<e;M++){let U=[];for(let le=0;le<n;le++)U.push({isActive:!1,type:ke.EMPTY});x.push(U)}return x}),[d,f]=fe.useState({row:0,col:0}),[p,g]=fe.useState(0),[w,y]=fe.useState(new Set),S=x=>{y(M=>new Set(M).add(x.key))},R=x=>{y(M=>{const U=new Set(M);return U.delete(x.key),U})};return fe.useEffect(()=>{const x=()=>{console.log("#####ctiveKeys",w),f(M=>{let{row:U,col:le}=M;return w.has("ArrowLeft")&&(le=Math.max(0,le-1),g(270)),w.has("ArrowRight")&&(le=Math.min(n-1,le+1),g(90)),w.has("ArrowUp")&&(U=Math.max(0,U-1),g(0)),w.has("ArrowDown")&&(U=Math.min(e-1,U+1),g(180)),{row:U,col:le}})};if(w.size>0){const M=setInterval(x,100);return()=>clearInterval(M)}},[w]),console.log("position",l),G.jsx("div",{tabIndex:"0",onKeyDown:S,onKeyUp:R,children:G.jsxs("div",{className:ui.board,children:[l==null?void 0:l.map(x=>G.jsx(ia,{p:x,site:"freeway"},x.id)),u.map((x,M)=>G.jsx("div",{className:ui.row,children:x.map((U,le)=>{const J=d.row===M&&d.col===le;return G.jsx(Ml,{isActive:J,tile:U},le)})},M))]})})}nv.propTypes={rows:Pe.number.isRequired,cols:Pe.number.isRequired,players:Pe.array,myPlayer:Pe.object};function cN(){const[r,e]=fe.useState(!0),[n,s]=fe.useState({}),[l,u]=fe.useState([]),[d,f]=fe.useState("home"),p=y=>{if(!y)return;let S=[];for(const R in y)R===n.id&&(s({id:R,...y[R]}),e(!1)),S.push({id:R,...y[R]});u(S)},g=()=>{qR(n==null?void 0:n.id),e(!0),s({})},w=()=>{d!=="home"&&(f("home"),gt(n==null?void 0:n.id,{page:"home"}))};return fe.useEffect(()=>Kc.onAuthStateChanged(S=>{if(S){let R=n;R.id=S.uid,s(R)}else console.log("User signed out")}),[Kc]),fe.useEffect(()=>{const y=Yl(ra,"players"),S=pT(y,R=>{p(R.val())});return()=>S()},[]),r?G.jsx(Zy,{user:n,setNewPlayer:e}):G.jsxs(G.Fragment,{children:[G.jsxs("div",{style:{padding:"1rem",fontWeight:"bolder",display:"flex",justifyContent:"space-between"},children:[G.jsx("button",{onClick:w,children:"Home"}),G.jsx("button",{onClick:g,children:"Reset"})]}),d==="home"&&G.jsx(tv,{myPlayer:n,players:l,setPage:f}),d==="forest"&&G.jsx(Jy,{rows:9,cols:12,myPlayer:n,players:l,setPage:f}),d==="freeWay"&&G.jsx(nv,{rows:10,cols:10,myPlayer:n,players:l})]})}a0.createRoot(document.getElementById("root")).render(G.jsx(fe.StrictMode,{children:G.jsx(cN,{})}));
